...
```
## Cấu trúc file
* phan_tich_2020_2024.py: xử lý và phân tích dữ liệu giai đoạn 2020–2024
* phan_tich_2025_backtest.py: xử lý và phân tích dữ liệu năm 2025 (bao gồm backtesting)
